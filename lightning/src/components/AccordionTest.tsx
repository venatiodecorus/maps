...
export default function AccordionTest() {
  const [currStation, setCurrStation] = createSignal({
    Latitude: 42.36,
    Longitude: -71.05625,
    Distance: 10,
    CountLimit: 10,
  });
  const [stations] = createResource(currStation, () =>
    fetchStations(currStation())
  );
                ...
                <AccordionItem value={station}>
                  ...
                  <AccordionPanel class="px-4 pt-4 pb-2 text-sm text-gray-500">
                    <ul>
                      ...
                      <li>
                        {station.Loc.City}, {station.Loc.State}{" "}
                        {station.Loc.Zip} {station.Loc.Country}
                      </li>
                      <li>
                        {station.Loc.CoordinateString},{" "}
                        {station.Loc.GeocodeStatus}
                      </li>
                    </ul>
                  </AccordionPanel>
                </AccordionItem>
